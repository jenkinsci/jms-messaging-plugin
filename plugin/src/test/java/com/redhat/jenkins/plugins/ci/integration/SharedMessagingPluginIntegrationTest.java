...
public abstract class SharedMessagingPluginIntegrationTest {
    ...
    public void _testVerifyModelUIPersistence() throws Exception {
        ...
        CIBuildTrigger trigger = new CIBuildTrigger(true, Collections.singletonList(getSubscriberProviderData("otopic",
                "HELLO", null, new MsgCheck(MESSAGE_CHECK_FIELD, MESSAGE_CHECK_VALUE))));
        ...
        job.setDefinition(new CpsFlowDefinition("node('built-in') {\n def message = sendCIMessage " + " providerName: '"
                + DEFAULT_PROVIDER_NAME + "', " + " overrides: [topic: 'otopic'], " + " failOnError: true, "
    ...
    public void _testSimpleCIEventTriggerWithDefaultValue() throws Exception {
        ...
        attachTrigger(new CIBuildTrigger(false, Collections.singletonList(getSubscriberProviderData(null, null, null))),
                jobA);
    ...
    public void _testSimpleCIEventSubscribeWithCheck() throws Exception {
        ...
        jobA.getBuildersList().add(new CIMessageSubscriberBuilder(
                getSubscriberProviderData(null, "HELLP", "", new MsgCheck(MESSAGE_CHECK_FIELD, MESSAGE_CHECK_VALUE))));
        ...
        jobB.getPublishersList()
                .add(new CIMessageNotifier(getPublisherProviderData(null, null, null, MESSAGE_CHECK_CONTENT)));
    ...
    public void _testSimpleCIEventSubscribeWithTopicOverride() throws Exception {
        FreeStyleProject jobA = j.createFreeStyleProject();
        jobA.getBuildersList().add(new CIMessageSubscriberBuilder(
                getSubscriberProviderData("otopic", "MESSAGE_CONTENT", "CI_TYPE = 'code-quality-checks-done'")));
        ...
        jobB.getPublishersList().add(new CIMessageNotifier(getPublisherProviderData("otopic",
    ...
    public void _testSimpleCIEventSubscribeWithCheckWithTopicOverride() throws Exception {
        FreeStyleProject jobA = j.createFreeStyleProject();
        jobA.getBuildersList().add(new CIMessageSubscriberBuilder(getSubscriberProviderData("otopic", "MESSAGE_CONTENT",
                "CI_TYPE = 'code-quality-checks-done'", new MsgCheck(MESSAGE_CHECK_FIELD, MESSAGE_CHECK_VALUE))));
    ...
    public void _testSimpleCIEventSubscribeWithTopicOverrideAndVariableTopic() throws Exception {
        ...
        FreeStyleProject jobB = j.createFreeStyleProject();
        jobB.getPublishersList().add(new CIMessageNotifier(getPublisherProviderData("my-topic",
                MessageUtils.MESSAGE_TYPE.CodeQualityChecksDone, "CI_STATUS = failed", "Hello World")));
        j.buildAndAssertSuccess(jobB);
    ...
    public void _testSimpleCIEventSubscribeWithCheckWithTopicOverrideAndVariableTopic() throws Exception {
        ...
        FreeStyleProject jobB = j.createFreeStyleProject();
        jobB.getPublishersList()
                .add(new CIMessageNotifier(getPublisherProviderData("my-topic", null, null, MESSAGE_CHECK_CONTENT)));
    ...
    public void _testSimpleCIEventTriggerWithPipelineSendMsg() throws Exception {
        ...
        WorkflowJob job = j.jenkins.createProject(WorkflowJob.class, "job");
        job.setDefinition(new CpsFlowDefinition("node('built-in') {\n def message = sendCIMessage " + " providerName: '"
                + DEFAULT_PROVIDER_NAME + "', " + " messageContent: '', " + " messageProperties: 'CI_STATUS = failed',"
    ...
    public void _testSimpleCIEventTriggerWithCheckWithPipelineSendMsg() throws Exception {
        ...
        attachTrigger(new CIBuildTrigger(false, Collections.singletonList(
                getSubscriberProviderData(null, null, null, new MsgCheck(MESSAGE_CHECK_FIELD, MESSAGE_CHECK_VALUE)))),
                jobA);

        WorkflowJob job = j.jenkins.createProject(WorkflowJob.class, "job");
        job.setDefinition(new CpsFlowDefinition("node('built-in') {\n def message = sendCIMessage " + " providerName: '"
                + DEFAULT_PROVIDER_NAME + "', " + " messageContent: '" + MESSAGE_CHECK_CONTENT + "'}\n", true));
    ...
    public void _testSimpleCIEventTriggerWithWildcardInSelector() throws Exception {
        ...
        attachTrigger(
                new CIBuildTrigger(false, Collections.singletonList(
                        getSubscriberProviderData(null, null, "compose LIKE '%compose_id\": \"Fedora-Atomic%'"))),
                jobA);
        jobA.getBuildersList().add(new Shell("echo CI_TYPE = $CI_TYPE"));

        FreeStyleProject jobB = j.createFreeStyleProject();
        jobB.getPublishersList().add(
                new CIMessageNotifier(getPublisherProviderData(null, MessageUtils.MESSAGE_TYPE.CodeQualityChecksDone,
    ...
    public void _testSimpleCIEventTriggerWithRegExpCheck() throws Exception {
        FreeStyleProject jobA = j.createFreeStyleProject();
        attachTrigger(new CIBuildTrigger(false, Collections.singletonList(
                getSubscriberProviderData(null, null, null, new MsgCheck("$.compose.compose_id", "Fedora-Atomic.+")))),
                jobA);
        jobA.getBuildersList().add(new Shell("echo job ran"));
        jobA.getBuildersList().add(new Shell("echo CI_MESSAGE = $CI_MESSAGE"));

        FreeStyleProject jobB = j.createFreeStyleProject();
        jobB.getPublishersList().add(new CIMessageNotifier(getPublisherProviderData(null, null, null,
                "{ \"compose\": { \"compose_id\": \"Fedora-Atomic-25-20170105.0\" } }")));
    ...
    public void _testSimpleCIEventTriggerWithTopicOverride() throws Exception {
        FreeStyleProject jobA = j.createFreeStyleProject();
        attachTrigger(new CIBuildTrigger(false, Collections.singletonList(getSubscriberProviderData("otopic", null,
                "CI_TYPE = 'code-quality-checks-done' and CI_STATUS = 'failed'"))), jobA);
        jobA.getBuildersList().add(new Shell("echo CI_MESSAGE = $CI_MESSAGE"));
    ...
    public void _testSimpleCIEventTriggerWithCheckWithTopicOverride() throws Exception {
        ...
        jobA.getBuildersList().add(new Shell("echo job ran"));
        attachTrigger(new CIBuildTrigger(false, Collections.singletonList(getSubscriberProviderData("otopic", null,
                null, new MsgCheck(MESSAGE_CHECK_FIELD, MESSAGE_CHECK_VALUE)))), jobA);

        FreeStyleProject jobB = j.createFreeStyleProject();
        jobB.getPublishersList()
                .add(new CIMessageNotifier(getPublisherProviderData("otopic", null, null, MESSAGE_CHECK_CONTENT)));
        j.buildAndAssertSuccess(jobB);
    ...
    public void _testSimpleCIEventTriggerWithTopicOverrideAndVariableTopic() throws Exception {
        ...
        attachTrigger(new CIBuildTrigger(false,
                Collections.singletonList(getSubscriberProviderData("org.fedoraproject.my-topic", null,
        ...
        jobB.addProperty(new ParametersDefinitionProperty(
                new StringParameterDefinition("MY_TOPIC", "org.fedoraproject.my-topic", "")));
    ...
    public void _testSimpleCIEventTriggerWithCheckWithTopicOverrideAndVariableTopic() throws Exception {
        FreeStyleProject jobA = j.createFreeStyleProject();
        attachTrigger(new CIBuildTrigger(false,
                Collections.singletonList(getSubscriberProviderData("org.fedoraproject.my-topic", null, null,
                        new MsgCheck(MESSAGE_CHECK_FIELD, MESSAGE_CHECK_VALUE)))),
                jobA);
        jobA.getBuildersList().add(new Shell("echo job ran"));
    ...
    public void _testSimpleCIEventTriggerWithParamOverride() throws Exception {
        FreeStyleProject jobA = j.createFreeStyleProject();
        attachTrigger(
                new CIBuildTrigger(false, Collections
                        .singletonList(getSubscriberProviderData(null, null, "CI_TYPE = 'code-quality-checks-done'"))),
                jobA);
    ...
    public void _testSimpleCIEventSubscribeWithNoParamOverride() throws Exception {
        ...
        jobA.getBuildersList().add(new CIMessageSubscriberBuilder(
                getSubscriberProviderData(null, "MESSAGE_CONTENT", "CI_TYPE = 'code-quality-checks-done'")));
    ...
    public void _testSimpleCIEventTriggerWithPipelineWaitForMsg() throws Exception {
        ...
        wait.setDefinition(new CpsFlowDefinition("node('built-in') {\n def scott = waitForCIMessage  providerName: '"
                + DEFAULT_PROVIDER_NAME + "', " + " selector: "
                + " \"CI_TYPE = 'code-quality-checks-done' and CI_STATUS = 'failed'\"  \necho \"scott = \" + scott}",
                true));
    ...
    public void _testSimpleCIEventTriggerWithCheckWithPipelineWaitForMsg() throws Exception {
        WorkflowJob wait = j.jenkins.createProject(WorkflowJob.class, "wait");
        wait.setDefinition(new CpsFlowDefinition("node('built-in') {\n def scott = waitForCIMessage  providerName: '"
                + DEFAULT_PROVIDER_NAME + "', " + " checks: [[field: '" + MESSAGE_CHECK_FIELD + "', expectedValue: '"
                + MESSAGE_CHECK_VALUE + "']]\n" + "}", true));
    ...
    public void _testSimpleCIEventTriggerWithSelectorWithCheckWithPipelineWaitForMsg() throws Exception {
        WorkflowJob wait = j.jenkins.createProject(WorkflowJob.class, "wait");
        wait.setDefinition(new CpsFlowDefinition(
        ...
        FreeStyleProject jobC = j.createFreeStyleProject();
        jobC.getPublishersList().add(new CIMessageNotifier(getPublisherProviderData(null,
    ...
    protected void stopContainer(DockerContainer container) throws Exception {
        System.out.println(Docker.cmd("stop", container.getCid()).popen().verifyOrDieWith("Unable to stop container"));
